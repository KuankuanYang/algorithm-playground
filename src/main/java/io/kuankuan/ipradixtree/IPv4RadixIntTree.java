...
public class IPv4RadixIntTree {
    ...
    public static void main(String[] args) throws UnknownHostException {
        IPv4RadixIntTree iPv4RadixIntTree = new IPv4RadixIntTree();
//        iPv4RadixIntTree.init(100000);
        long start = System.currentTimeMillis();
        iPv4RadixIntTree.put("10.0.10.1/1", 100);
        long end = System.currentTimeMillis();
        System.out.println(iPv4RadixIntTree.selectValue("10.0.10.1"));
        System.out.println(iPv4RadixIntTree.selectValue("10.0.10.2"));
...
//            }
    ...
    public void putIp(String singleIp, int value) throws UnknownHostException {
        long ip = inet_aton(singleIp);
        put(ip, 0xffffffffL, value);
    }
